...
<aside class="container">
  ...
  <table class="table">
      <tbody>
        ...
        <td>Name: {{$appointment->userAppointment->lastName}}, {{$appointment->userAppointment->firstName}}</td>
        <td>Email: {{$appointment->userAppointment->email}}</td>
        <td>Date Created: {{$appointment->created_at}}</td>
          ...
          <td>Physician: {{$appointment->employeeAppointment->userEmployee->firstName}} {{$appointment->employeeAppointment->userEmployee->lastName}}</td>
          <td></td>
        </tr>
          @endforeach
          </tbody>
